        ...
        while(option!=7){
            ...
            switch (option){
                ...
                case 2:
                    ...
                    try {
                        ...
                        if (!userBookingService.loginUser()) {
                            ...
                            userBookingService = new UserBookingService(); // fallback to empty for other operations
                        } else {
                ...
                case 4:
                    ...
                    trainSelectedForBooking = trains.get(selectedTrainIndex - 1);
                    break;
                case 5:
                    if (trainSelectedForBooking == null) {
                        System.out.println("You have not selected a train. Please search and select a train first.");
                        break;
                    }
                ...
                case 6:
                    ...
                    if(cancelled.equals(Boolean.TRUE)){
                        ...
                        System.out.println("Could not cancel booking. Please check your ticket ID.");
                    }
                    break;
                case 7:
                    // Exit the App
